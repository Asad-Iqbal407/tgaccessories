  ...
  return (
    <>
      ...
      <button
        ...
        className="md:hidden fixed top-4 right-4 z-50 bg-white p-2 rounded-lg shadow-lg text-slate-600 hover:text-primary transition-colors"
      >
          ...
          <div className="p-4 border-t border-slate-100">
            <div className="flex items-center mb-4 px-2">
              ...
              <div className="ml-3">
                ...
                <p className="text-xs text-slate-500">tariq@gmail.com</p>
              </div>
            </div>
            <button
